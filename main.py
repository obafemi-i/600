...
# Load previously scraped URLs from the file to avoid scraping duplicates
try:
...
def run(playwright: Playwright) -> None:
    ...
    for domain in domains:
        ...
        # generate image name to correspond with number of images scraped
        ...
        # Save the scraped URLs to the scraped URLs file
